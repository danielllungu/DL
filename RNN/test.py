...
if __name__ == '__main__':
    ...
    char_rnn_dataset = CharRnnDataset('mihaieminescu.txt', max_len)

    net = CharRNN(vocab_size, 128)
    if torch.cuda.is_available():
        net.cuda()

    net.load_state_dict(torch.load('weights/epoch_2', map_location=torch.device('cpu')))
